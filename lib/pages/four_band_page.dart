...
class _FourBandPageState extends State<FourBandPage> {
  ...
  final List<String> colors4 = ['Marron', 'Rojo', 'Dorado', 'Plateado'];
  ...
  void _pError(){
    if (_opcionSeleccionada4! =='Marron'){
      _tolerancia= '1%';
    }
  ...
  void _calcularResistencia() {
    if (_opcionSeleccionada != null &&
      ...
      if (_opcionSeleccionada3! == 'Negro') {
        _resistencia = ((colors1.indexOf(_opcionSeleccionada!) + 1.0) * 10.0 +
            (colors2.indexOf(_opcionSeleccionada2!))) as double;
      } else if (_opcionSeleccionada3! == 'Marron') {
        _resistencia = ((colors1.indexOf(_opcionSeleccionada!) + 1.0) * 10.0 +
                (colors2.indexOf(_opcionSeleccionada2!))) *
            10.0 as double;
      } else if (_opcionSeleccionada3 == 'Rojo') {
        _resistencia = ((colors1.indexOf(_opcionSeleccionada!) + 1.0) * 10.0 +
                (colors2.indexOf(_opcionSeleccionada2!))) *
            100.0 as double;
      } else if (_opcionSeleccionada3 == 'Naranja') {
        _resistencia = ((colors1.indexOf(_opcionSeleccionada!) + 1.0) * 10.0 +
                (colors2.indexOf(_opcionSeleccionada2!))) *
            1000.0 as double;
      } else if (_opcionSeleccionada3 == 'Amarillo') {
        _resistencia = ((colors1.indexOf(_opcionSeleccionada!) + 1.0) * 10.0 +
                (colors2.indexOf(_opcionSeleccionada2!))) *
            10000.0 as double;
      } else if (_opcionSeleccionada3 == 'Verde') {
        _resistencia = ((colors1.indexOf(_opcionSeleccionada!) + 1.0) * 10.0 +
                (colors2.indexOf(_opcionSeleccionada2!))) *
            100000.0 as double;
      } else if (_opcionSeleccionada3 == 'Azul') {
        _resistencia = ((colors1.indexOf(_opcionSeleccionada!) + 1.0) * 10.0 +
                (colors2.indexOf(_opcionSeleccionada2!))) *
            1000000.0 as double;
      } else if (_opcionSeleccionada3 == 'Dorado') {
        _resistencia = ((colors1.indexOf(_opcionSeleccionada!) + 1.0) * 10.0 +
                (colors2.indexOf(_opcionSeleccionada2!))) /
            10.0 as double;
      } else if (_opcionSeleccionada3 == 'Plateado') {
        _resistencia = ((colors1.indexOf(_opcionSeleccionada!) + 1.0) * 10.0 +
                (colors2.indexOf(_opcionSeleccionada2!))) /
            100.0 as double;
      }
          ...
          children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Center(
                      child: Text(
                        'Resistencias de 4 bandas', // Título de la aplicación
                        style: TextStyle(
                            fontSize: 25,
            ...
            Positioned(
              ...
              child: DropdownButton<String>(
                ...
                // La opción actualmente seleccionada
                items: colors3.map((String color3) {
                  return DropdownMenuItem<String>(
                    value: color3,
                    child: Row(
                      children: [
            ...
            Positioned(
              ...
              child: DropdownButton<String>(
                ...
                // La opción actualmente seleccionada
                items: colors4.map((String color4) {
                  return DropdownMenuItem<String>(
                    value: color4,
                    child: Row(
                      children: [
