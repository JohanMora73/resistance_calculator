...
class SixBandPage extends StatefulWidget {
  const SixBandPage({super.key});

  @override
  State<SixBandPage> createState() => _SixBandPageState();
}

class _SixBandPageState extends State<SixBandPage> {
  ...
  void _pErrorYPpm(){
    ...
    if (_opcionSeleccionada6! == 'Marron'){
      _ppm = '100 ppm';
    }
    else if (_opcionSeleccionada6! == 'Rojo'){
      _ppm = '50 ppm';
    }
    else if (_opcionSeleccionada6! == 'Amarillo'){
      _ppm = '25 ppm';
    }
    else if (_opcionSeleccionada6! == 'Naranja'){
      _ppm = '15 ppm';
    }
    else if (_opcionSeleccionada6! == 'Azul'){
      _ppm = '10 ppm';
    }
    else if (_opcionSeleccionada6! == 'Purpura'){
      _ppm = '5 ppm';
    }
    else if (_opcionSeleccionada6! == 'Blanco'){
      _ppm = '1 ppm';
    }
  }
          ...
          children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Center(
                      child: Text(
                        'Resistencias de 6 bandas', // Título de la aplicación
                        style: TextStyle(
                            fontSize: 25,
            ...
            Positioned(
              ...
              child: DropdownButton<String>(
                ...
                dropdownColor: Colors.white,
                // Texto por defecto antes de seleccionar
                value: _opcionSeleccionada6,
                // La opción actualmente seleccionada
                items: colors6.map((String color6) {
                  return DropdownMenuItem<String>(
                    value: color6,
                    child: Row(
                      children: [
            ...
            Positioned(
              ...
              left: 5,
              child: Text(
                "La resistencia es de: ${_resistencia} ${_Ohmios} ${_tolerancia} ${_ppm}",
                style:
